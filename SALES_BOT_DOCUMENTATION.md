...
ربات فروش یک اپلیکیشن PHP است که از طریق HTTP API با پنل VPN-UI ارتباط برقرار می‌کند. این ربات قابلیت‌های زیر را ارائه می‌دهد:
...
پنل VPN-UI از **Session Cookie** برای احراز هویت استفاده می‌کند. **هیچ API Key وجود ندارد.**
